...
var stroke = new Vivus('mask', {
    type: 'oneByOne', // 一本ずつ描画
    duration: 100, // アニメーションの時間（数字が大きいほど遅い）
    forceRender: false,
    animTimingFunction: Vivus.EASE,
});

// アニメーションが終わったらスプラッシュ画面を消す処理
stroke.play(function () {
    $('#splash').fadeOut(500, function () {
        // ここを追加！スプラッシュが消えきった瞬間に本編アニメを開始
...
$(window).on('load', function () {
    ...
    $('#splash')
        ...
        .fadeOut('slow', function () {
            //ローディングエリア（splashエリア）を1.5秒でフェードアウトした後に下記を実行
            $('body').addClass(
                'appear',
            ); /*機能編 4-2-8 背景色が円形に縮小（中央へ）の関数を呼ぶ*/
        });
